...
import (
	...
	"github.com/ibm/ibm-licensing-hub-operator/pkg/apis"
	"github.com/ibm/ibm-licensing-hub-operator/pkg/controller"
	"github.com/ibm/ibm-licensing-hub-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "ibm-licensing-hub-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
